/**
 * Security Event Types for Cloud Run API
 * Local copy to avoid path issues
 */
...
export type SecurityEventType = 
  ...
  | 'CHAT_RATE_LIMIT_EXCEEDED' // New event type for chat-specific rate limiting
...
export const SECURITY_EVENT_DESCRIPTIONS: Record<SecurityEventType, string> = {
  ...
  'CHAT_RATE_LIMIT_EXCEEDED': 'Enhanced chat rate limit exceeded with detailed monitoring',
...
export const EVENT_SEVERITY_MAP: Record<SecurityEventType, SecuritySeverity> = {
  ...
  'CHAT_RATE_LIMIT_EXCEEDED': 'HIGH', // High priority for AI endpoint abuse
