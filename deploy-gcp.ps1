# Parliament Explorer - GCP Cloud Run Deployment Script
...
Write-Host "🏛️  Parliament Explorer - GCP Deployment Setup" -ForegroundColor Green
...
try {
    ...
    Write-Host "⚠️  Firestore database may already exist or creation failed." -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "⚠️  Cloud Build logs bucket may already exist." -ForegroundColor Yellow
}
